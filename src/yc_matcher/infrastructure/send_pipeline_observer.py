...
class SendPipelineObserver:
    ...
    def decision_response(self,
                         ...
                         output_types: list,
                         latency_ms: int,
                         decision_json_ok: bool = True) -> None:
        """Log decision response."""
        self._emit("decision_response", {
            "decision": decision,
            "auto_send": auto_send,
    ...
    def send_gate(self,
                  ...
                  mode: str,
                  auto_send: bool,
                  remaining_quota: int = 0) -> None:
        """Log all gate checks before send."""
        self._emit("send_gate", {
            "stop": stop,
            "quota_ok": quota_ok,
            "seen_ok": seen_ok,
            "mode": mode,
