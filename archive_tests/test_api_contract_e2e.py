...
def test_decision_call_contract():
    ...
    print(f"   ✓ Section 4: Use responses.create() for GPT-5")
    print(f"   ✓ Section 5: Required params: model, input, max_output_tokens")
    print(f"   ✓ Section 6: Try response_format first, fall back if error")
    print(f"   ✓ Section 7: Temperature optional (0.2-0.5)")
    print(f"   ✓ Section 11: Use response.output_text if available")
    print(f"   ✓ Section 12: Skip reasoning items in manual parse")
